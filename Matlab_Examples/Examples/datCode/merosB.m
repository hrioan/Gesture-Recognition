%% MEROS B
%% Epanalabete ta parapanw gia klaseis me koino alla mh diagwnio mhtwo
%% syndiasporas, iso me S = [0.6, 0.4 ; 0.4, 0.6] (Bhmata B.1-B.6). Oi
%% proteres pi9anothtes twn klasewn, P(ùi), kai oi meses times twn p(x|ùi)
%% paramenoun ws exoun sto Meros A (e3.(1)). Sxoliaste tis diaforopoihseis
%% meta3y twn ta3inomhtwn Eukleideias apostashs, apostashs Mahalanobis, kai
%% tou Bayesian ta3inomhth se sxesh me autes tou Merous A ths ergasias.
%%
diary on;
clear; clc;
disp('MEROS B');
