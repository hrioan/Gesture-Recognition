...
utils/prepare_lang.sh --position-dependent-phones false --num-nonsil-states 5 --num-sil-states 5 data/local/dict "<SIL>" data/local/lang data/lang
local/prepare_lm.sh

# move label file to test_gestures
cp LabelFiles data/test_gestures/text
#cat LabelFiles data/test_gestures/text > data/test_gestures/text2
#mv data/test_gestures/text2 > data/test_gestures/text

#--num-nonsil-states 50
############################## Feature Extraction ##############################
